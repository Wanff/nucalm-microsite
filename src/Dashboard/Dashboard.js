...
const Dashboard = () =>{
    ...
    <p className = "subHero-header">NuCalm<sup><sup>®</sup></sup> 3.0 is the next evolution of NuCalm<sup><sup>®</sup></sup>, and it’s as comprehensive as it is revolutionary.</p>
    <p className = "subHero-tracks">Everything you need to know about NuCalm<sup><sup>®</sup></sup> 3.0—how NuCalm<sup><sup>®</sup></sup> 3.0 will bring you the most effective results you’ve ever experienced, how your interaction with the app will change, the benefits of already being in the NuCalm<sup><sup>®</sup></sup> community, how to download the new app, why we evolved, and what’s next.</p>
    ...
    <h1 className = "hero-tracks"> NuCalm<sup><sup>®</sup></sup> 3.0 Sneak Peek</h1>
        <p className = "subtext-tracks"><span className = "span-mobile-hover"> Below you will find the three main screens that correspond to experiencing a NuCalm<sup><sup>®</sup></sup> journey. The first screen is the new home page, the second shows where you will select your journey time, and the third will display your session summary. Hover over the sidebar</span><span className = "span-mobile-read">Read the feature descriptions and check out the app screenshots</span> below to get a sneak peek of the NuCalm<sup><sup>®</sup></sup> 3.0 App's exciting new features including a larger catalog of new neuroacoustic software, outcome-driven journeys, greater variation on time selection, session statistics, educational content, and more. </p>
    ...
    <div className = "nucalm_screens_container">
        ...
        <NuCalmHover number = "1. " star_position={{top:"18%", left:"9%"}} title = "Daily Message Box" text = "This feature will allow us to share tips and tricks on how to best optimize your NuCalm<sup><sup>®</sup></sup> experience. "/>
        <NuCalmHover number = "2. " star_position={{top:"39%", left:"7%"}} title = "Journey Information" text = "By clicking on any of the NuCalm<sup><sup>®</sup></sup> journeys you will learn what each is designed to do for both the body and the mind."/>
        <NuCalmHover number = "3. " star_position={{top:"80.2%", left:"26.7%"}} title = "In App Support Function" text = "Get help on demand! This support feature will bring you right to our Help Center or connect you with the NuCalm<sup><sup>®</sup></sup> Customer Care Team. "/>
        <NuCalmHover number = "4. " star_position={{top:"83%", left:"15.2%"}}title = "Learn" text = "Become a NuCalm® expert by checking out news articles, tutorials, and our NuCalm<sup><sup>®</sup></sup> 101 lessons. "/>
        <NuCalmHover number = "5. "star_position={{top:"83%", left:"20.6%"}} title = "Stats" text = "Coming later in September after our first launch, you will be able to see a full history of your NuCalm<sup><sup>®</sup></sup> sessions, a your dynamic NuCalm<sup><sup>®</sup></sup> Score, and more."/>
        ...
        <NuCalmHover number = "9. " star_position={{top:"76%", left:"43%"}} title = "Alarm" text = "Need an extra reminder your NuCalm<sup><sup>®</sup></sup> session is complete - set an alarm!"/>
        ...
        <div class="hover-bar-mobile">
            <p className = "hover-title-bar">1. Daily Message Box: This feature will allow us to share tips and tricks on how to best optimize your NuCalm<sup><sup>®</sup></sup> experience.  </p>
            <p className = "hover-title-bar">2. Journey Information: By clicking on any of the NuCalm<sup><sup>®</sup></sup> journeys you will learn what each is designed to do for both the body and the mind.</p>
            <p className = "hover-title-bar">3. In App Support Function: Get help on demand! This support feature will bring you right to our Help Center or connect you with the NuCalm<sup><sup>®</sup></sup> Customer Care Team. </p>
            <p className = "hover-title-bar">4. Learn: Become a NuCalm<sup><sup>®</sup></sup> expert by checking out news articles, tutorials, and our NuCalm<sup><sup>®</sup></sup> 101 lessons. </p>
            <p className = "hover-title-bar">5. Stats: Coming later in September after our first launch, you will be able to see a full history of your NuCalm<sup><sup>®</sup></sup> sessions, a your dynamic NuCalm<sup><sup>®</sup></sup> Score, and more. </p>
            ...
            <p className = "hover-title-bar">9. Alarm: Need an extra reminder your NuCalm<sup><sup>®</sup></sup> session is complete - set an alarm! </p>
    ...
    <h1 className = "hero-tracks"> NuCalm<sup><sup>®</sup></sup> 3.0 Journey Details </h1>
