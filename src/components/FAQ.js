    ...
    return (
      <div className="modal">
        ...
        <div class = "popUpContent">
            ...
            <p className = "answer">Yes! With the lifetime access you originally purchased, you will never have to spend another dime on NuCalm's neuroacoustic software - in whatever app format it comes in. Your only ongoing cost will be for NuCalm Biosignal Processing discs, and the occasional eye mask.</p>

            <p className = "question"> How do I switch over to the new app?</p>
            <p className = "answer">When the NuCalm 3.0 App is available, it will show up as an update in your App Store or Google Play Store. While connected to the internet, update the app and NuCalm 3.0 will appear on your phone or smart device. Please note that your old password for the NuCalm app will have expired and you will need to be reset to a more secure one before you can log in to the new app. You will be emailed this information and the link to reset your password, or you can reset your password by clikcing on "Forgot Password?" in the new app. </p>
                    
            <p className = "question">Which of the new tracks are similar to the old ones? How do I find my favorite track? </p>
            <p className = "answer">We have a large collection of new and more sophisticated tracks embedded throughout the NuCalm 3.0 Journeys, but we have kept your favorites in there as well. We are taking the stress out of track selection - you will choose your outcome and time, we'll give you what you need.</p>
            ...
            <p className = "answer">The old NuCalm app was simply a media player designed primarily for clinical use (as for many years we operated business-to-business). In order to continue the shift to the consumer market, we needed a more user-friendly, intuitive, aesthetically appealing, and functional app. We took all of your feedback and worked with experts in app development to build a new app with new neuroacoustic software journeys and new in-app features. </p>
      
            <p className = "question">Why does my old password not work? </p>
            <p className = "answer">Your old password will no longer be valid for the new NuCalm app. To get started with the NuCalm 3.0 app, you will need to create a new secure password. You will be emailed this information and the link to reset your password, or you can reset your password by clikcing on "Forgot Password?" in the new app. </p>
            ...
            <p className = "answer">2. Outcome- Driven NuCalm Journeys: Now you can take the guesswork out of track selection-- just choose your time and desired outcome, and we'll provide the best track.</p>
            ...
            <p className = "answer">4. Learn Section: Everything you need in one place-- research, tutorials, FAQs, blogs, NuCalm news, and educational articles.</p>
            <p className = "answer">5. Overall more functionality: Enjoy a fresh new look with more functionality, based on NuCalm user feedback.</p>
